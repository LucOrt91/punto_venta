...
export function DatesFilters(component: any) {
  let datesFilterArray = [
    {
      labelDate: component.component.datesFilterArray[0],
      dateInit: component.component.filters.startDate,
      dateFin: component.component.filters.endDate,
    },
    {},
  ];

  let dialogDatesFilters = component._dialog.open(SearchFilterComponent, {
    width: "380px",
    data: datesFilterArray,
  });

  dialogDatesFilters.componentInstance.datesFilter.subscribe((data) => {
    ...
    dialogDatesFilters.close(true);
  });

  dialogDatesFilters.afterClosed().subscribe((data: any) => {
    if (data) {
